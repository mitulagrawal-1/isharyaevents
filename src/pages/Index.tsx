...
const weddingServices = [
  {
    ...
    bullets: [
      "Floral installations & mandaps",
      "Custom stage & furniture layout",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Gourmet fusion counters",
      "Artisanal desserts & mocktail bars",
    ],
  },
  {
    id: "hospitality",
    ...
    bullets: [
      "RSVP & room block management",
      "Welcome hampers & stationery",
  ...
  },
  {
    ...
    bullets: [
      "Sufi bands & DJ lineups",
      "Sangeet choreography",
      "Cinematic highlight films & albums",
    ],
  },
];
...
const philosophy = [
  {
    ...
    copy: "We respect and elevate local Indian customs, styling events around specific regional rituals with authentic touches.",
  },
  {
    n: "02",
    title: "Complete Coordination",
    copy: "From vendor negotiations and guest lodging to the final send-off, we hold single-point accountability.",
  },
  {
    n: "03",
    title: "Immersive Design",
    copy: "We design layouts, scent profiles, lighting cues, and audio timelines to build a cohesive world.",
  },
  {
    n: "04",
    title: "Stress-Free Celebration",
    copy: "We build redundancies into everything so you and your family can celebrate without a single phone call.",
  },
];
...
const testimonials = [
  {
    quote:
      "The floral decor, glass-mandalas, and overall management were beyond royal. Ishera events executed every ritual with cultural precision and stunning grandeur.",
  ...
  {
    quote:
      "From the spectacular helicopter entry to the 20-course royal Awadhi feast, they transformed our Lucknow wedding into an absolute fairytale. Flawless on-ground coordination!",
    name: "Rohan & Meera",
  ...
  {
    quote:
      "Our Sangeet night felt like a high-production Bollywood concert! The stage design, sound, and choreographers provided by the team were top-notch.",
  ...
  {
    quote:
      "They handled guest hospitality for 500+ guests beautifully. Airport transfers, luxury hampers, room arrangements — everything was handled with absolute warmth and efficiency.",
    name: "Dr. Alok Verma",
  ...
  {
    quote:
      "The Haldi decor with floating marigold swings and dhol-tasha troupe created the most vibrant morning. We didn't have to stress about a single detail.",
    name: "Divya & Kabir",
...
function HorizontalMarigolds({ className = "" }: { className?: string }) {
  return (
    <div
      className={`w-full flex justify-around items-start overflow-hidden pointer-events-none select-none h-10 ${className}`}
    >
      {Array.from({ length: 24 }).map((_, i) => (
        <div
          key={i}
          className="flex flex-col items-center shrink-0 -space-y-0.5 animate-flower-sway"
...
function LotusDivider() {
  return (
    <div className="flex items-center justify-center gap-4 text-saffron/70 py-4 select-none">
      ...
      <svg
        className="w-6 h-6 text-saffron fill-current"
        viewBox="0 0 24 24"
    ...
    <div className="relative w-full bg-sand/35 border-y border-gold/15 py-12 my-12 overflow-hidden flex flex-col items-center justify-center select-none pointer-events-none">
      ...
      <div className="text-center px-6 max-w-2xl mt-4">
        ...
        <p className="text-xs sm:text-sm text-charcoal/65 leading-relaxed italic max-w-xl mx-auto font-light">
          "Marigolds represent the warmth of the sun and bring prosperity to the union, while fresh
          jasmine Mogra strands fill the air with sweet blessings."
        </p>
      </div>
    ...
    <div className="min-h-screen bg-ivory text-charcoal selection:bg-marigold/20 font-sans antialiased overflow-x-hidden relative">
          ...
          <div className="fixed right-0 top-0 bottom-0 w-[80%] max-w-[350px] bg-ivory shadow-2xl p-8 flex flex-col justify-between border-l border-gold/20 animate-in slide-in-from-right duration-300">
            <div className="space-y-8">
              <div className="flex justify-between items-center">
                <div className="flex flex-col">
                  <span className="font-serif text-lg tracking-[0.2em] text-maroon font-bold uppercase">
                    ISHERA
                  </span>
                  <span className="text-[7.5px] tracking-[0.4em] text-gold uppercase -mt-1 font-sans">
                    EVENTS & WEDDINGS
                  </span>
                </div>
                <button
            ...
            <div className="space-y-6 pt-12 border-t border-gold/15">
              <div className="space-y-3">
                <p className="text-[9px] uppercase tracking-[0.2em] text-charcoal/40 font-bold">
                  Contact Concierge
                </p>
                <a
                  href="tel:+918543818567"
                  className="block text-sm font-serif hover:text-saffron transition-colors"
                >
                  +91 85438 18567
                </a>
                <a
                  href="mailto:info@isheraevents.com"
                  className="block text-sm font-serif hover:text-saffron transition-colors"
                >
                  info@isheraevents.com
                </a>
              </div>
              <a
                href="#contact"
      ...
      <section className="relative h-[70vh] sm:h-[75vh] md:h-[80vh] min-h-[500px] max-h-[720px] bg-charcoal overflow-hidden flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-20">
          <div className="max-w-3xl space-y-6 md:space-y-8 text-ivory">
            ...
            <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-[1.08] font-bold text-pretty">
              Weaving <span className="text-marigold italic font-normal">Heritage</span>, Grandeur,
              &amp; Royal Romance
            </h1>

            <p className="text-sm sm:text-base md:text-lg text-pretty max-w-[62ch] leading-relaxed text-ivory/80 font-light">
              From historic palace pheras under jasmine canopy pathways to high-octane Bollywood
              sangeets, we design and execute luxury celebrations with absolute cultural
              authenticity.
            </p>
        ...
        <div className="absolute bottom-6 right-6 hidden md:block bg-ivory/95 backdrop-blur-sm p-4 border border-gold/20 shadow-md z-20">
          ...
          <p className="text-[8px] uppercase tracking-[0.2em] text-charcoal/50 font-bold mt-0.5">
            Signature Weddings 2026
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-y-8 gap-x-4">
            {stats.map((s, idx) => (
              <div key={idx} className="text-center space-y-1">
                ...
                <p className="text-[9px] sm:text-[10px] uppercase tracking-[0.25em] text-charcoal/50 font-bold">
                  {s.label}
                </p>
              </div>
            ))}
              ...
              return (
                <div key={r.id} className="grid md:grid-cols-12 gap-8 md:gap-12 items-center">
                  ...
                  <div className="md:col-span-5 bg-ivory p-6 border border-gold/15 flex flex-col justify-center text-center space-y-6 relative">
                    ...
                    <p className="text-[9.5px] uppercase tracking-[0.25em] text-gold font-bold">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {weddingServices.map((service, idx) => {
              ...
              return (
                <article
                  key={idx}
                  className="group bg-ivory border border-gold/15 flex flex-col justify-between overflow-hidden shadow-sm hover:shadow-md transition-all duration-500"
                >
                  ...
                  <div className="p-6 flex-grow flex flex-col justify-between space-y-4">
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-charcoal/65 leading-relaxed">{service.desc}</p>
                    </div>
                    ...
                    <div className="pt-2 border-t border-gold/10">
                      <ul className="space-y-1.5">
                        {service.bullets.map((b, i) => (
                          <li
                            key={i}
                            className="text-[10.5px] text-charcoal/70 flex items-center gap-1.5"
                          >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {themes.map((theme, i) => (
              <div
                key={i}
                className="bg-sand/35 border border-gold/15 p-6 flex flex-col justify-between hover:border-gold transition-all duration-300 shadow-sm relative"
              >
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <span
                      className={`w-8 h-8 rounded-full flex items-center justify-center text-[10px] font-bold text-ivory shadow-sm ${theme.color}`}
                    >
                      0{i + 1}
                    </span>
                    <h3 className="font-serif text-lg font-bold text-maroon">{theme.name}</h3>
                  </div>
                  <p className="text-[10.5px] font-semibold tracking-wider text-saffron uppercase">
                    {theme.tagline}
                  </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-[0.8fr_1.2fr] gap-12 lg:gap-20 items-center">
            <div className="space-y-6">
              <span className="text-[10px] uppercase tracking-[0.25em] text-marigold font-bold block">
                Our Philosophy
              </span>
              <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-bold leading-tight">
                Crafting Stress-Free{" "}
                <span className="text-marigold italic font-normal">Royal Celebrations</span>
              </h2>
              <p className="text-sm sm:text-base text-ivory/70 leading-relaxed font-light">
                An Indian wedding is not just an event; it's a multi-day family reunion filled with
                sentiment, ritual, and celebration. Our philosophy centers on absorbing all
                logistical friction so you can focus entirely on the emotion of the moment.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {philosophy.map((p) => (
                <div key={p.n} className="space-y-3 border-t border-marigold/30 pt-6">
                  <span className="font-serif text-marigold text-2xl italic font-semibold">
                    {p.n}
                  </span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-12 gap-4 sm:gap-6">
            <div className="col-span-2 md:col-span-6 relative overflow-hidden aspect-[4/5] sm:aspect-square md:aspect-auto md:h-full min-h-[350px] group border border-gold/10">
              ...
              <div className="absolute bottom-6 left-6 text-ivory">
                <p className="text-[9px] uppercase tracking-wider text-marigold font-bold">
                  The Saffron Aura
                </p>
              ...
              <div className="grid grid-cols-2 gap-4 sm:gap-6">
                <div className="relative overflow-hidden aspect-square group border border-gold/10">
                  ...
                  <div className="absolute bottom-3 left-3 text-ivory">
                    <p className="text-[8px] uppercase tracking-wider text-marigold font-bold">
                      Bridal Trousseau
                    </p>
      ...
      <section
        id="testimonials"
        className="py-20 bg-sand/35 border-t border-gold/15 overflow-hidden"
      >
              ...
              >
                ...
                <div className="border-t border-gold/10 pt-4 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-[9px] text-charcoal/40 uppercase tracking-widest mt-0.5">
                      {t.sub}
                    </p>
                  </div>
                ...
                >
                  ...
                  <div className="border-t border-gold/10 pt-4 flex flex-col gap-2">
                    <div>
                      ...
                      <p className="text-[9.5px] text-charcoal/40 uppercase tracking-widest mt-0.5">
                        {t.sub}
                      </p>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-sm text-charcoal/65 leading-relaxed font-light">
                We accept only a limited number of weddings each season to ensure absolute dedicated
                attention, meticulous details, and personal concierge services for your family.
              </p>
              ...
              <div className="space-y-6 pt-4 border-t border-gold/15">
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    ...
                    <a
                      href="tel:+918543818567"
                      className="text-sm font-serif hover:text-saffron transition-colors font-bold"
                    >
                      +91 85438 18567
                    </a>
                  </div>
                ...
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    ...
                    <a
                      href="https://instagram.com/ishera_events"
                      target="_blank"
              ...
              {formSubmitted ? (
                <div className="py-16 text-center space-y-6 animate-in fade-in duration-500">
                  ...
                  <p className="text-xs text-charcoal/60 max-w-sm mx-auto leading-relaxed">
                    Thank you. Our luxury wedding concierge team will review your date availability
                    and reach out to you on WhatsApp / Phone within 24 hours.
                  </p>
                  <LotusDivider />
                </div>
              ) : (
                <form onSubmit={handleFormSubmit} className="space-y-6">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <label className="text-[9px] uppercase tracking-[0.2em] text-charcoal/50 font-bold block">
                        Your Name *
                      </label>
                  ...
                  <div className="space-y-1">
                    <label className="text-[9px] uppercase tracking-[0.25em] text-charcoal/50 font-bold block">
                      Event Date / Month
                    </label>
                    <div className="relative">
          ...
          <div className="mt-20 pt-8 border-t border-gold/15 flex flex-col sm:flex-row gap-6 justify-between items-center text-[10px] uppercase tracking-[0.25em] text-charcoal/40 font-bold">
            ...
            <div className="flex gap-6">
              <a href="#rituals" className="hover:text-saffron transition-colors">
                Rituals
              </a>
              <a href="#services" className="hover:text-saffron transition-colors">
                Services
              </a>
              <a href="#themes" className="hover:text-saffron transition-colors">
                Themes
              </a>
            </div>
          </div>
